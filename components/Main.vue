...
<template>
    <div class="w-full h-screen overflow-x-hidden overflow-y-auto flex flex-col items-center">
        ...
        <div class="flex flex-col w-[1000px] max-w-[80%] min-h-screen gap-10 relative top-10 border-2 border-black" v-else>
            <!-- hellur -->
            <NoteEditor/>
        </div>
    </div>
