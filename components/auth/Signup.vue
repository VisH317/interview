...
watch([email, password, retype], ([e, p, r]) => {
    ...
    if (e.length === 0 || p.length === 0 || r.length === 0)
        disabled.value = true
    else {
...
<template>
    <Modal open-def="signup-modal">
        <div class="w-full h-full flex justify-center">
            ...
            <div
                class="w-[60%] flex flex-col items-center justify-center gap-1"
            >
                ...
                >
                    ...
                    <span class="block sm:inline"
                        >Those passwords dont match</span
                    >
                </div>
                <div
                ...
                >
                    <hr
                        class="w-64 h-px my-8 bg-gray-200 border-[1px] border-slate-300 dark:bg-slate-600"
                    />
                    <span
