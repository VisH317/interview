        ...
        <div class="w-full h-full flex justify-center">
            ...
            <div class="w-[60%] flex flex-col items-center justify-center gap-4">
                ...
                <div class="group relative flex flex-row items-center transition ease-in-out duration-300 hover:-translate-y-1 hover:opacity-[0.85] w-48 h-24">
                    ...
                    <div class="group-hover:shadow-lg border-2 border-slate-800 bg-slate-800 text-white duration-300 transition ease-in-out bg-slate-800 text-2xl font-light rounded-lg h-14 w-40 cursor-pointer text-center flex justify-center items-center z-20 absolute left-4 top-5" @click="action">Sign Up</div>
                </div>
