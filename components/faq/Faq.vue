...
type FAQ = { title: string; desc: string }
...
<template>
    <div
        class="w-full bg-white min-[500px]:p-20 max-[500px]:py-20 max-[500px]:px-5 min-[500px]:pl-48 flex flex-col gap-16"
    >
        <p class="text-5xl font-bold text-slate-800 max-[500px]:text-center">
