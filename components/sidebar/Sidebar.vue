...
<template>
    <div class="flex-none bg-slate-200 h-screen w-[260px] overflow-x-hidden overflow-y-auto flex flex-col">
        <div class="flex-none flex flex-row gap-3 items-center w-full cursor-pointer p-5">
            ...
            <p class="text-slate-800 font-semibold text-2xl">
                Interview<span class="text-transparent bg-clip-text bg-gradient-to-r from-pink-300 to-blue-300">Sense</span>
            </p>
        </div>
