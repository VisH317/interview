...
<template>
    <div class="w-screen min-h-screen overflow-x-hidden flex flex-row">
        <div class="flex-none bg-slate-100 h-screen w-[300px] overflow-x-hidden overflow-y-auto flex flex-col">
            <div class="flex flex-row gap-3 items-center w-full cursor-pointer p-5 justify-center">
            ...
            <div class="h-4"/>
            <div class="w-full">
                <div class="w-full p-5 hover:bg-slate-300 duration-300 text-slate-400 font-normal text-xl cursor-pointer">⚙️ Settings </div>
                <div class="w-full p-5 hover:bg-slate-300 duration-300 text-slate-400 font-normal text-xl cursor-pointer">📒 Account</div>
            </div>
            <div class="h-4"/>
            <div class="p-5">
