...
<template>
    <div>
        <div class="w-screen min-h-screen overflow-x-hidden flex flex-row">
            <div
                class="flex-none bg-slate-100 h-screen w-[260px] overflow-x-hidden overflow-y-auto flex flex-col"
            >
                <div
                ...
                <div class="flex-none py-10">
                    <hr
                        class="h-[2px] w-[90%] mx-auto bg-gray-200 border-0 dark:bg-slate-400 rounded-lg"
                    />
                    <div class="h-4" />
                    <div
                        class="group w-full p-5 hover:bg-slate-300 duration-300 text-slate-400 font-normal text-xl cursor-pointer flex gap-4"
                        @click="() => (open = true)"
                    >
                        <div class="inline">
                            <font-awesome-icon
